...
- [x] 03-a-little-less-conversation — **done (2026-07-22); Wave B measure layout 2026-07-24:** lead vocal / chords while singing / no fills / hard stop on single; scroll **14** + `leadInSec` **10**; measure Estimate **7** + **10** (Satisfy orphans cleared — dial on device).
...
**Next review queue (handoff):** **Wave B** measure-only. **03 A Little Less Conversation** layout shipped — awaiting measure dial (seed 7/10). Then 07–13, 15–18, 20–21, 23, 25. Done: 01 (6/56), 02 (6/12). Parked: Dream On / Mama / Voodoo / Purple Rain V3.
