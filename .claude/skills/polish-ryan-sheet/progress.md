...
- [ ] 27-fat-bottomed-girls — **drafted (2026-07-23 polish):** album form Chorus→V→Interlude→V→Chorus→Solo×4→Outro; sparse open vol-down; Interlude labeled; double-hook + cold bikes; chords only; scroll **6** + leadIn **16**. Device dial.
