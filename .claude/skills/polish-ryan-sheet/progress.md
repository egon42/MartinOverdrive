...
- [ ] 28-mama-i-m-coming-home — **drafted (form research 2026-07-24):** studio form fixed — Pre1 (took me in) → V2 → Pre2 (Selfish love lift) → Chorus1 Face hundred + short tag → Bridge G A E×3+B → Solo 7 bars → Pre3 → Chorus2 Face thousand → Outro C D E×3. Cheat hints/solo chip updated (form order already matched). scroll **6** + leadIn **17**; measure Estimate **6** + **17** (re-dial after form).
