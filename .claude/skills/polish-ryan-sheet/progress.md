...
Setlist order = `src/data/setlist.json` ids.

**Status meanings:**

| Marker | Meaning |
|---|---|
| unchecked, no note | No `.ryan.txt` yet |
| **drafted** | Sheet on `/dev/` with Estimate scroll seed; not stage-locked |
| `[x]` **done** | Ear-checks done, scroll dialed + seeded (`note` drops Estimate / says Locked), no known placement bugs |

Bulk draft marks **drafted** only. Only the user saying lock / perfect / locked promotes to `[x]`.
...
- [x] 02-all-the-small-things — **done (2026-07-22; verse rows 2026-07-24); Wave B measure 2026-07-24:** power `*5`; ringing early pre / full late pre; instrumental ×2; interlude prepare ghosts + (C C C B)×3; verse rows = 4 chips (C5 G5 F5 G5); scroll **8** + `leadInSec` **12**; measure **6** + **12**.
- [x] 03-a-little-less-conversation — **done (2026-07-22); Wave B measure 2026-07-24; key restore 2026-07-26:** lead vocal / chords while singing / no fills / hard stop on single; restored **A7–D7** (was band E); scroll **14** + `leadInSec` **10**; measure **11** + **10**. Re-dial if A crawl feels off.
...
- [x] 15-dani-california — **done (2026-07-23); Wave B measure 2026-07-24:** Intro+Interlude ×2 packed; verse couplets 4-across; hang Calif/She's/Pus pickups; Solo F C Dm G; scroll **9** + lead-in **6**; measure **8** + **6** (good enough). **V2/V3 end tags Am G Dm (guitar):** "love my baby to death" + "Gone too fast" matched V1 survive cycle.
- [x] 16-teenage-dirtbag — **done (2026-07-23); Wave B measure 2026-07-24:** Intro/reprise E B E A packed; hang verse/pre/chorus pickups; walk-ups packed; scroll **11** + lead-in **14**; measure **12** + **14**.
- [x] 17-the-pretender — **done (2026-07-23); Wave B measure 2026-07-24:** hang intro/verse/chorus lyric rows; bridge A5 packed; scroll **9** + leadIn **11**; measure **8** + **11** (good enough). **Guitar:** pre-verse instrumental is one Am sit-out (was ×4).
- [x] 18-here-it-goes-again — **done (2026-07-23); Wave B measure 2026-07-24:** hang verse/pre/chorus pickups; Intro/Link/Outro packed; scroll **12** + leadIn **8**; measure **11** + **8** (good enough). **Guitar:** chorus phrase breaks (I-should-have + Oh-here tag); bridge powers Eb5 Bb5 G5/B C5 Eb5/G Ab5.
...
- [x] 20-when-i-come-around — **done (2026-07-23); Wave B measure 2026-07-24:** F# C# D# B phrase breaks restored (first hang pass glued cycles); chord-first pickups; Intro/Solo/Outro packed; scroll **11** + leadIn **9**; measure **10** + **9** (good enough).
- [x] 21-the-middle — **done (2026-07-23; frets fixed 2026-07-24); Wave B measure 2026-07-24:** verses map to intro `9 5 9 7 4` / `5 4 5 5`; solo packed; chorus D A G D; scroll **6** + leadIn **16**; measure **6** + **16** (good enough).
...
- [x] 25-valerie — **done (2026-07-23); Wave B measure 2026-07-24:** E F#m verse pairs; pre A G#m phrases; chorus E F#m; scroll **8** + leadIn **12**; measure **7** + **12** (good enough).
...
- [ ] 30-pink-pony-club — **drafted (good enough 2026-07-23; layout 2026-07-24; +1 fret 2026-07-26):** band G (powers G5 A5 E5 C5; bridge **C5 D5 E5 A5** ×2 — not verse loop); 3Red/4Red; scroll **9** + leadIn **10.7**; measure **8** + **10.7**. Re-dial if G frets feel denser.
...
Locked **13** · good-enough **3** · drafted **15**. Biggest miss: scroll estimates from **non-empty line** ratios ran ~2× fast on dense UG sheets (Dani 17→9, Dirtbag 22→11). Skill now uses blank-separated **rows** + `scripts/estimate-scroll.mjs`, soft-cap ≤12, lead-in tree, peer anchors. On polish: re-estimate history-pass seeds before dialing.
