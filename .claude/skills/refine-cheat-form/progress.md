...
- **23-lola-montez** — **Research applied 2026-07-16 (old = "Jul 15 sheet-aligned"):** Outro removed — all 5 sources end on a final Chorus (high conf); Bridge rebuilt `(D A Bm G)×2` instrumental + `Em A D G…` vocal + tag (card's `(A D G)×2 A G A` was missing Bm/Em — high conf); solos ride the Interlude loops (hint); chorus endings D · F#m · D; D major standard ✓; verse/interlude alternation confirmed
