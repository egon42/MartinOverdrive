...
- **15-dani-california** — Intro×2 → Verse×8 → Chorus → Interlude×2 → Verse×4 → Chorus → Interlude×2 → Bridge×3 → Verse×4 → Chorus×2; Intro/Interlude = verse pattern; Chorus `(F C Dm)×4`
