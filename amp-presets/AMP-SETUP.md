...
| 3 | FUNK DRY CLEAN | '65 Deluxe Reverb | 1×12 Deluxe | 3.5 | 7.5 | 6.5 | 4.5 | 4.5 | Bright ON, '65 Spring reverb (3) |
...
| 6 | COUNTRY SNAP | '59 Bassman | 4×10 Bassman | 4 | 6 | 6.5 | 5.5 | 4.5 | Bright ON, Compressor (5) + '65 Spring (2) |
...
| 14 | LEAD SOLO | British '70s | 4×12 G | 7.5 | 5 | 5.5 | **7** | 5 | Mono Delay (lvl 4, time 4.5, fdbk 3.5) + Small Hall (3) — mid-pushed so solos cut |
...
| '59 Bassman | #6 COUNTRY SNAP (g4 v6 t6.5 b4.5, C1 low) | #7 TEXAS BLUES (g6.5 v5.5 t6 b5.5, C2) |
...
| British '60s | #10 CLASSIC ROCK stand-in (g6 v5 t6 b5.5) | #14 LEAD stand-in (g7.5 v5 t5.5 b5, DLY/REV **D1** = tape delay + large hall in one) |
