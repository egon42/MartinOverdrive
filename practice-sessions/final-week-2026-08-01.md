...
- Written: 2026-07-26; **superseded/refreshed 2026-07-27** (final-week stage push)
...
- Daily engine: Body Pre → **practice-session** → **/coach** → Body Post. Desk board + body micro in dead meetings.
- App work: **stage-cheat-card** (kill-zone + Ryan→Cheat lifts). Ryan polish parked.
- Resume anywhere: **`/continue`** (reads this file + `HANDOFF.md`).
...
Triggers: `/continue` · `continue final week` · `where was I` · `resume push`

Skill: `.claude/skills/continue-final-week/`. Living bookmark: [`HANDOFF.md`](HANDOFF.md) (overwrite on every pause).
...
| Slot | When | Time |
| --- | --- | --- |
| **Desk micro** | Every ~45–60 min sitting / after desk-board | 2–3 min |
...
## Kill-zone Cheat queue (daytime — freeze Thu)
...
Nice-if-time: Lola F#m/Em; Hunger amp; Dirtbag full chords cue; Fat Bottomed stops; Hunger `(…)\|(…)` row groups if still broken.

## Dual-track calendar

| Day | Day — app | Day — desk | Eve — guitar |
| --- | --- | --- | --- |
| **Mon 7/27** | Trackers + kill-zone start (Pretender, Valerie…) | Fret-2 + body micro | Body Pre → Priority Lola+Mama+Darkness 10+Thunderstruck → slice **#17–#31** → Body Post |
| **Tue 7/28** | Mama, DSB, Darkness cues | Am/Em barre + body micro | Body Pre → DSB+Hunger+Dirtbag → slice **#1–#16** → Body Post |
| **Wed 7/29** | Gently Weeps; Middle lift; Thunderstruck if needed | Powers + E5–B5 + body micro | Body Pre → changeovers 3→Darkness, 16→Pretender, 5→Thunderstruck, 24→Valerie, 20→Middle, 26→Fat Bottomed → Body Post |
| **Thu 7/30** | Leftovers + UI; **freeze cards** | Fret-2 + body micro | Body Pre → weakest ≤3 (max 3) + abbreviated full set → Body Post |
...
| Desk + body micro | `desk board` / `body` / `stretch` |
...
- `/continue` lands correctly via `HANDOFF.md`
