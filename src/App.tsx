...
export default function App() {
  return <div className="app-shell">
    ...
    <main><Routes><Route path="/" element={<Dashboard />} /><Route path="/practice" element={<Practice />} /><Route path="/songs" element={<Navigate to="/practice" replace />} /><Route path="/song/:id" element={<SongDetail />} /><Route path="/set" element={<SetlistPage />} /><Route path="/show" element={<Show />} /><Route path="/settings" element={<SettingsPage />} /><Route path="*" element={<Dashboard />} /></Routes></main>
  </div>
}
