...
// B/G dyad: `6/5` or `2/4-5` (G pull / two frets on G). Display as written.
const DYAD_FRET_RE = /^((?:[0-9]|1[0-9]|2[0-4]))\/((?:[0-9]|1[0-9]|2[0-4])(?:-(?:[0-9]|1[0-9]|2[0-4]))?)$/
...
/** Measure barline in Ryan fret sheets (`6/5 4/5 | 3/5 2/5`). */
export const isBarlineToken = (token: string) => token === '|'
