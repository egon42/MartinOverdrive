...
const emptyEntry: PracticeEntry = { status: 'Not Started', notes: '', lastPracticed: '', sessions: 0, priority: 0, secondsPracticed: 0, savedSongsterrUrl: '', savedUltimateGuitarUrl: '', preferredSource: '', scrollSpeed: 0, updatedAt: '' }
